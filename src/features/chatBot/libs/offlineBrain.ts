...
export const OfflineBrains = {
  ...
  company: {
    ...
    response: () =>
      `**${companyInfo.name}** is a leading software solutions provider with ${companyInfo.experience} of experience serving ${companyInfo.clients}. Founded by ${companyInfo.founder} with ${companyInfo.coDirector} as Co-Director, we specialize in delivering innovative business software across various industries in Uganda and beyond.`,
  },
  contact: {
    keywords: [
      'contact',
  ...
  location: {
    ...
    response: () =>
      `Our office is located at **${companyInfo.address}**. We're open ${companyInfo.hours}. Feel free to visit us or contact us at ${companyInfo.phone} to schedule an appointment.`,
  },
  ...
  ritebooks: {
    ...
    response: () =>
      `**${products.ritebooks.name}** is our flagship ERP solution designed for medium to large businesses.\n\n${products.ritebooks.description}\n\n**Key Features:**\n${products.ritebooks.features
        .slice(0, 5)
        .map((f) => `• ${f}`)
        .join(
          '\n',
  ...
  riteEats: {
    ...
    response: () =>
      `**${products.riteEats.name}** - Complete restaurant and hospitality management.\n\n${products.riteEats.description}\n\n**Key Features:**\n${products.riteEats.features
        .slice(0, 6)
        .map((f) => `• ${f}`)
        .join(
          '\n',
  ...
  customDevelopment: {
    ...
    response: () =>
      `We offer **Custom Software Development** tailored to your unique business needs. Whether you need a web application, desktop software, or specialized business tools, our experienced team can build it from scratch to match your exact requirements.`,
  },
  mobileApp: {
    keywords: [
      'mobile app',
    ...
    response: () =>
      `Our **Custom Mobile Application Development** service creates powerful iOS and Android apps for your business. From concept to deployment, we handle everything to bring your mobile vision to life.`,
  },
  uraEfris: {
    keywords: [
      'ura',
    ...
    response: () =>
      `We provide complete **URA EFRIS Integration** services to ensure your business complies with Uganda's tax regulations. Our solutions seamlessly integrate with your existing systems for automated invoicing and tax reporting.`,
  },
  tallyServices: {
    keywords: [
      'tally customization',
  ...
  cloudHosting: {
    ...
    response: () =>
      `Our **Cloud Hosting & Backup** services ensure your business data is secure, accessible, and always available. We provide reliable cloud infrastructure with automated backups, 99.9% uptime, and 24/7 monitoring.`,
  },
  webDevelopment: {
    keywords: [
      'website',
    ...
    response: () =>
      `We build professional **Websites** that drive business growth. From corporate sites to e-commerce platforms, we handle design, development, hosting, and ongoing maintenance.`,
  },
  ecommerce: {
    keywords: [
      'ecommerce',
    ...
    response: () =>
      `Our **E-Commerce Integration** services help you sell online effectively. We build and integrate complete online stores with payment gateways, inventory sync, and order management.`,
  },
  ...
  farewell: {
    ...
    response: () =>
      `Goodbye! 👋 Thank you for contacting Lotus Soft Technologies. If you have any more questions in the future, feel free to reach out. Have a great day! 😊`,
  },
  ...
  thanks: {
    ...
    response: () =>
      `You're welcome! If you have any other questions about our products or services, feel free to ask. We're here to help! 😊`,
  },
...
const findBestMatch = (
  ...
  if (humanKeywords.some((keyword) => lowerInput.includes(keyword))) {
    return {
      response: () =>
        `I'm sorry, but I'm unable to fully process your request at the moment. Kindly click the button below to connect with a human representative for further assistance.`,
      showWhatsApp: true,
    }
  }
