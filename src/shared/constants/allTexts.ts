...
import { FaCloudDownloadAlt, FaHandsHelping, FaMobileAlt, FaPhoneAlt, FaReply, FaShieldAlt } from "react-icons/fa";
import { FaCartShopping, FaCloud, FaComputer, FaGlobe, FaLaptop, FaLocationDot, FaTrophy } from "react-icons/fa6";
...
export const TotalData: TotalDataItem[] = [
  {
    ...
    title: "Empowering Africa's Businesses with Smart, ScalableSoftware & Technology Solutions.",
    descriptionSecond: "Simplifying operations, automating workflows, and driving growth through innovation. Welcome to Lotus Soft Technologies Ltd., Uganda's leading provider of business software and IT solutions.",
    target: "/",
  ...
  {
    name: 'Products',
    title: "Lotus Soft Technologies offers a suite of integrated business software products designed for diverse industries.",
    target: "/",
  ...
  },
  {
    ...
    description: "We’re here to assist you with any inquiries about our products, services, or custom solutions. Reach out to us through the contact form below or use the provided information to connect with our team directly.",
    section: [
  ...
  },
  {
    ...
    features: [
      ...
      {
        star: 5,
        description: 'The integration with URA EFRIS has streamlined our compliance processes, making financial reporting effortless and reliable.',
      ...
      {
        star: 5,
        description: 'Their innovative solutions have significantly improved our HR workflows, enhancing team productivity and accuracy.',
      ...
      {
        star: 5,
        description: 'The seamless integration with URA EFRIS and Tally has transformed our financial operations, saving us time and boosting accuracy.',
